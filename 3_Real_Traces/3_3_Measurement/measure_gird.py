...
# Start and end position of the cpu
myEM.set_pos_A([-123000, 144000, -97000])
myEM.set_pos_B([-75000, 197000, -97000])

# myEM.set_pos_A([-138300, 183416, -97000])
# myEM.set_pos_B([-111668, 219000, -97000])
...
#Numer of traces, traces per file and samples
if __name__ == "__main__":
    num_traces = 5000
    traces_per_file = 1000
    samples_per_trace = 10000
    ...
    # ciphertext = np.empty([traces_per_file, 16], np.uint8)
    ...
    for x_pos in xrange(0,no_steps_x):
        for y_pos in range(0,no_steps_y):
          ...
          #Measurement and sending to the device
          for i in xrange(0, num_traces):
                ...
                #Check recieved data with sBox calculation
